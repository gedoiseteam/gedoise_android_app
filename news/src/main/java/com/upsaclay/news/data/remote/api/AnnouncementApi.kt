...
interface AnnouncementApi {
    ...
    suspend fun createAnnouncement(@Body announcementDTO: AnnouncementDTO): Response<IntResponse>

    @DELETE("announcements/{id}")
    suspend fun deleteAnnouncement(@Path("id") id: Int): Response<EmptyResponse>

    @POST("announcements/update")
    suspend fun updateAnnouncement(@Body announcementDTO: AnnouncementDTO): Response<EmptyResponse>
}