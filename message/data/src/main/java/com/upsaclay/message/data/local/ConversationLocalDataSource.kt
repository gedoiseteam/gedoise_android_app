...
internal class ConversationLocalDataSource(private val conversationDao: ConversationDao) {
    fun getAllConversationsFlow(): Flow<List<LocalConversation>> = conversationDao.getAllConversationsFlow()

    fun getAllConversations(): List<LocalConversation> = conversationDao.getAllConversations()
