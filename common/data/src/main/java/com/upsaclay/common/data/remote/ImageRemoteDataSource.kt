...
internal class ImageRemoteDataSource(private val imageApi: ImageApi) {
    suspend fun uploadImage(file: File): Response<com.upsaclay.common.domain.model.ServerResponse.EmptyResponse> = withContext(Dispatchers.IO) {
        try {
    ...
    suspend fun deleteImage(imageName: String): Response<com.upsaclay.common.domain.model.ServerResponse.EmptyResponse> = withContext(Dispatchers.IO) {
        try {
